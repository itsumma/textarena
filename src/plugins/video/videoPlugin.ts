...
const defaultOptions: VideoPluginOptions = {
  ...
  icon: `<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="4 4 16 16">
      <g>
        <path d="M8 4h8v1.997h2V4c1.105 0 2 .896 2 2v12c0 1.104-.895 2-2 2v-2.003h-2V20H8v-2.003H6V20c-1.105 0-2-.895-2-2V6c0-1.105.895-2 2-2v1.997h2V4zm2 11l4.5-3L10 9v6zm8 .997v-3h-2v3h2zm0-5v-3h-2v3h2zm-10 5v-3H6v3h2zm0-5v-3H6v3h2z"/>
      </g>
  </svg>`,
  title: 'Video',
  tag: 'ARENA-VIDEO',
